...
Background: users and tasks have been added to database
  ...
  | MIDTERM1  | CS164  | Exam     | 1/Mar/2015 12:00:00 -8000  | 1/Apr/2015 16:00:00 -0800  | Started  | 1       | 1    |
...
Scenario: all the unifinished past due tasks should automatically change status
  ...
  Then I should see "PROJ1" with the scope of "New"
  Then I should see "MIDTERM1" with the scope of "New"
