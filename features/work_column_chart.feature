...
In order to visualize the workload of my current tasks
...
When I press “Workload” 
Then I should see the “estimate workload” 
Then I should see “column chart” 

scenario: column chart should change as I add the task 
Given I am in the home page 
When I add    | HW2       | CS186  | Homework | 27/Feb/2015 23:59:00 -0800 | 2/Mar/2015 23:59:00 -0800  | Started  | 2       |  
Then I should see the “estimate workload” increase 
When I delete | HW2       | CS186  | Homework | 27/Feb/2015 23:59:00 -0800 | 2/Mar/2015 23:59:00 -0800  | Started  | 2       |  
Then I should see the “estimate workload” decrease
