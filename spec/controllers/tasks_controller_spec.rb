...
describe TasksController do
  ...
  let(:valid_attributes) { {:title => 'Quiz#2', :course => 'CS169', :kind => 'Exam', :release => '12/Mar/2015 23:59:00 -0800', :due => '19/Mar/2015 23:59:00 -0800', :status => 'New', :user_id => 1} }
  ...
  describe "GET new" do
    it "assigns a new task as @task", :pending => true do
  ...
  describe "POST create", :pending => true do
    describe "with valid params" do
      ...
      it "redirects to the created task", :pending => true do
        post :create, {:task => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved task as @task" do
        ...
        post :create, {:task => { "title" => "invalid value" }}, valid_session
        assigns(:task).should be_a_new(Task)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested task" do
        ...
        Task.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => task.to_param, :task => { "title" => "MyString" }}, valid_session
      end
